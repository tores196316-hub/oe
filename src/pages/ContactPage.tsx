  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      <div className="text-center space-y-2">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">İletişim & Destek</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-8 rounded-3xl bg-white dark:bg-[#12131b] border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-6">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <MessageSquare className="w-5 h-5 text-indigo-600 dark:text-indigo-400" /> Bize Mesaj Gönderin
          </h2>

          {sent ? (
            <div className="p-6 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-200 border border-emerald-200 dark:border-emerald-800/80 text-center space-y-2">
              <CheckCircle2 className="w-10 h-10 text-emerald-600 dark:text-emerald-400 mx-auto" />
              <p className="font-bold text-sm">Mesajınız Alındı!</p>
              <p className="text-xs text-emerald-700 dark:text-emerald-300">En kısa sürede e-posta adresiniz üzerinden geri dönüş sağlayacağız.</p>
              <button
                onClick={() => setSent(false)}
                className="mt-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-semibold"
              >
                Yeni Mesaj Yaz
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Konu</label>
                <input
                  type="text"
                  value={form.subject}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 rounded-xl bg-slate-900 dark:bg-indigo-600 hover:bg-slate-800 dark:hover:bg-indigo-500 text-white text-sm font-semibold shadow-xs flex items-center justify-center gap-2 transition-colors cursor-pointer"
              >
                <Send className="w-4 h-4 text-indigo-400 dark:text-indigo-200" />
          ...
          <div className="p-8 rounded-3xl bg-white dark:bg-[#12131b] border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-6">
            ...
            <div className="space-y-4 text-xs text-slate-600 dark:text-slate-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-slate-900 dark:text-white">Merkez Ofis</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-slate-900 dark:text-white">Sosyal Medya</p>
